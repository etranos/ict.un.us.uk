...
```{r}
ggplot(data = data, aes(x=hh.net.share, y=r_diff_tr)) + geom_point() + geom_smooth(method = "lm")
```
...
summary(base <- lm(r_diff_tr ~ hh.net.share + log(pop2013) + un13 + white2013share +
...
summary(int_density <- lm(r_diff_tr ~ hh.net.share*I(pop2013/area_h) + log(pop2013) + un13 + white2013share +
                     log(income2013) + I(pop2013/area_h) + service2013 + commuting.minutes2013, data = data))
...
summary(int_pop <- lm(r_diff_tr ~ hh.net.share*log(pop2013) + log(pop2013) + un13 + white2013share +
                     log(income2013) + I(pop2013/area_h) + service2013 + commuting.minutes2013, data = data))
...
summary(model_iv1 <- ivreg(r_diff_tr ~ hh.net.share + log(pop2013) + un13 + white2013share +
...
summary(model_iv2 <- ivreg(r_diff_tr ~ hh.net.share + log(pop2013) + un13 + white2013share +
                     log(income2013) + I(pop2013/area_h) + service2013 + commuting.minutes2013 |
                       log(pop2013) + un13 + white2013share +
                       log(income2013) + I(pop2013/area_h) + service2013 + commuting.minutes2013 +
...
# Table 6
data.for.decr <- data %>%
  dplyr::select(r_diff_tr, hh.net.share, pop2013, un13,white2013share, 
...
stargazer(base, int_density, int_pop, base_glm, type="html",
          ...
          omit.stat = c("rsq", "f"), notes = "Robust Std. Error in parenthesis")
