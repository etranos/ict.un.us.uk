...
The present paper does not address the issue that adoption of ICT may have different effects on urban dispersion on a national scale, that is how far are major areas, that is, cities, from one another, versus dispersion within major urban areas, that is urban sprawl. Such an inquiry would require detailed data about patterns how urban sprawl  may hamper or promote economic interaction, given advancements in information technology. We think that data from the Covid-19 pandemic would likely throw light at this issue, as it is clear that not all economic activities might continue in an unencumbered manner; see Dingel and Neiman (2020).

Jonathan Dingel and Brett Neiman, "How Many Jobs Can Be Done at Home?", Becker Friedman Institute, University of Chicago, April 2020. https://tinyurl.com/y9nbmkmz
...
{[}18{]}. The first step of our methodology is to estimate the Pareto exponent
coefficient for a broad sample of countries over time. \textbf{The Pareto} coefficient
...
This leads to an estimate of \(\zeta\), known as the the Zipf coefficient,
but more appropriately the Pareto exponent, a terminology we will adhere to for the remained of the text, even  when \(\zeta\) is 
estimated to be near \(1\). The term Zipf coefficient should be reserved fo the special case of \(\zeta=1\), While much of the literature focuses on the
Pareto exponent being close to \(1\), several estimations of city size
...
\caption{\label{tab:unnamed-chunk-2}Pareto Exponent\label{zipf}}
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrrrrrrrrrrrrrr}
\toprule
Pareto exp. & 2000 & 2001 & 2002 & 2003 & 2004 & 2005 & 2006 & 2007 & 2008 & 2009 & 2010 & 2011 & 2012 & 2013 & 2014 & 2015 & 2016 & 2017 & 2018\\
\midrule
...
Pareto inv. sq. error\textsuperscript{a} & 950 & 0.01 & 0.1 & 0.05 & 0.2 \\
...
penetration might be affected by spatial structure, as reflected in the Pareto 
exponents, or both internet penetration and spatial structure might
...
standard error of the estimated  the Pareto exponent (see Table
...
interpretation of the estimated coefficients, given that the Pareto exponent
 has entered the regression not as an absolute value, but
...
It is indeed puzzling that the results on Table \ref{2sls.global} that the effects on urban concentration for internet users and broadband users, on the one hand, and mobile and fixed telephony users are in opposite directions. We wish to broach this subject in the context of some related literature, namely Calabrese \emph{et al.} (2011)

Interplay between Telecommunications and Face-to-Face Interactions: A Study Using Mobile Phone Data

Francesco Calabrese ,Zbigniew Smoreda,Vincent D. Blondel,Carlo Ratti

Published: July 13, 2011https://doi.org/10.1371/journal.pone.0020814

and 

B\"{u}chel and Ehrlich 

Cities and the Structure of Social Interactions:
Evidence from Mobile Phone Data

http://staff.vwi.unibe.ch/vonehrlich/Papers/BuchelEhrlich012019.pdf

The latter supports the notion that ICT favors agglomeration in the sense that in spite of their convenience modern technologies do no make up for the need of proximity in  social interactions. The former supports the notion people who communicate more frequently are likely to be near one another. ICT, as viewed through such granular studies of individuals' communications does not make up for physical distance; individuals nearer one another communicate more.  


In order to overcome the city size limitation, the next section
...
\cline{2-3}
\\[-1.8ex] & \multicolumn{2}{c}{Normalized difference in ranks, 2013-18} \\
...
Residual Std. Error & \multicolumn{1}{c}{0.008} & \multicolumn{1}{c}{0.008} \\
\hline
\hline \\[-1.8ex]
...
Urban Settlements data and test the effect of ICT adoption on the Pareto exponents for national city size distributions, as
